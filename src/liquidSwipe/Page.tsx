    ...
    <div id={`pageContainer${index}`} {...bind()}>
      ...
      {prev && (
        <>
          ...
          >
            <span className={"text-white"}><svg height="100%" width="30px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><g fill="currentColor" stroke="currentColor" stroke-linecap="square" stroke-linejoin="miter" stroke-miterlimit="10" stroke-width="4"><polyline fill="none" points="46,60 18,32 46,4 " stroke="currentColor"></polyline></g></svg></span>
          </animated.button>
        </>
      )}
      <LQSW_PAGE
